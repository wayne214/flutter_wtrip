///旅拍页modal
class TravelPageModel {
  int totalCount;
  List<TravelPageItem> resultList;

  TravelPageModel({this.totalCount, this.resultList});

  TravelPageModel.fromJson(Map<String, dynamic> json) {
    totalCount = json['totalCount'];
    if (json['resultList'] != null) {
      resultList = new List<TravelPageItem>();
      json['resultList'].forEach((v) {
        resultList.add(new TravelPageItem.fromJson(v));
      });
    }
  }
...
class TravelPageItem {
  int type;
  Article article;

  TravelPageItem({this.type, this.article});

  TravelPageItem.fromJson(Map<String, dynamic> json) {
    type = json['type'];
    article =
